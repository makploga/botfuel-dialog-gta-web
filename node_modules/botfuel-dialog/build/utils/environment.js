...
var checkCredentials = function checkCredentials(config) {
  ...
  if (!BOTFUEL_APP_ID || !BOTFUEL_APP_KEY) {
    if (config.qna) {
      throw new MissingCredentialsError('BOTFUEL_APP_ID and BOTFUEL_APP_KEY are required to use Botfuel QnA.');
    }
    if (config.spellchecking) {
      throw new MissingCredentialsError('BOTFUEL_APP_ID and BOTFUEL_APP_KEY are required to use the spellchecking service.');
    }
  }
